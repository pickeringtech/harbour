...
final class PackageIntegrationTest extends TestCase
{
    public function test_commands_are_registered(): void
    {
        ...
        foreach (['workspace:install', 'workspace:uninstall', 'workspace:setup', 'workspace:dev', 'workspace:teardown', 'workspace:status', 'workspace:env', 'workspace:render', 'workspace:debug'] as $name) {
