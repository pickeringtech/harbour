...
final class InstallCommand extends WorkspaceCommand
{
    protected $signature = 'workspace:install
        ...
        {--worktree-hooks= : Worktree lifecycle integration: none or worktrunk}
    ...
    public function handle(
        ...
        return $this->executeSafely($json, function () use ($installer, $detector, $starter, $services, $preflight, $dependencies, $runtime, $application, $worktrunk, $json): int {
    ...
    private function worktreeHooks(bool $json): array
    {
        ...
        if ($option === null) {
            ...
            $selected = multiselect(
                ...
                options: ['worktrunk' => 'Worktrunk (full lifecycle)'],
                default: [],
        ...
        foreach ($selected as $integration) {
            if ($integration !== 'worktrunk') {
                throw new HarbourException(
                    ErrorCode::InvalidInstallSelection,
                    "Unsupported worktree lifecycle integration [{$integration}]. Choose one of: worktrunk, none.",
                );
            }
        }
